...
internal class YTDownloaderCache : IYTDownloader
{
    ...
    internal YTDownloaderCache(
        IYTDownloader downloader,
        YTDownloaderCacheState state
    )
    {
        this._downloader = downloader;
        this._cache = new();
    ...
    internal YTDownloaderCacheState DumpState()
    {
        ...
        {
            cache = this
                ._cache.Select(x => new YTDownloaderCacheState.UrlSongPath()
                {
                    url = x.Key,
    ...
    public async Task<Song> DownloadVideoAsync(
        string url,
    ...
    )
    {
        ...
        {
            var song = await this
                ._downloader.DownloadVideoAsync(url, progressFunc)
